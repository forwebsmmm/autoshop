  ...
  public function shoppingCart($attrs) {
    ...
    if(is_object($cart) && $cart->countItems()) {
      ...
      <div id="Cart66scCartContents">
        ...
        <span id="Cart66scCartCountText"><?php echo $cart->countItems() > 1 ? ' товаров' : ' товар' ?></span>
        <span id="Cart66scCartCountDash">&ndash;</span>
        <span id="Cart66scCartPrice"><?php echo Cart66Common::currency($cart->getSubTotal()); ?>
        </span></a>
        <a id="Cart66scViewCart" href='<?php echo get_permalink($cartPage->ID) ?>'>Просмотреть корзину</a>
